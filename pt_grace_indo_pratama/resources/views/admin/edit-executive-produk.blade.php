        ...
        <section class="bg-gray-200/80 p-5 shadow border border-gray-300 rounded-xl">
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
                ...
                <div>
                    ...
                    <input name="id_produk" type="text" value="{{ old('id_produk', $product->id_produk) }}"
                        placeholder="Contoh: BHOS001"
                ...
                <div>
                    ...
                    <input name="nama_produk" type="text" value="{{ old('nama_produk', $product->nama_produk) }}"
