            ...
            <table class="w-full text-sm text-left text-gray-800">
                ...
                <tbody class="bg-gray-200 divide-y divide-gray-500">
                    <tr class="hover:bg-gray-300">
                        <td class="px-6 py-4 text-left font-semibold">30/11/2025</td>
                        <td class="px-6 py-4 text-left font-semibold">Bambang Pratama Putra Hadi</td>
                        <td class="px-6 py-4">
                        ...
                        <td class="px-6 py-4 text-left font-semibold text-gray-600">Menunggu</td>
                    </tr>
                    ...
                    <tr class="hover:bg-gray-300">
                        ...
                        <td class="px-6 py-4 text-left font-semibold text-[#EC0000]">Ditolak</td>
                    </tr>
                    ...
                    <tr class="hover:bg-gray-300">
                        ...
                        <td class="px-6 py-4 text-left font-semibold text-[#2E7E3F]">Disetujui</td>
                    </tr>
