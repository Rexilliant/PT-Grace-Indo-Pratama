...
@section('menu-barang-masuk', 'bg-gradient-to-r from-[#53BF6A] to-[#275931] text-white')
            ...
            <div class="overflow-x-auto">
                <table class="w-full text-sm text-left text-gray-800">
                    <thead class="bg-[#5aba6f]/70 text-gray-900">
                        <tr>
                            <th scope="col" class="px-6 py-3 font-extrabold text-left">Tanggal Masuk</th>
                            <th scope="col" class="px-6 py-3 font-extrabold text-left">Nama Penerima</th>
