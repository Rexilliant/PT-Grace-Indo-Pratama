...
@section('content')
    @php
        $inputClass = 'w-full rounded-2xl border border-slate-200 bg-slate-50 px-4 py-3 text-sm text-slate-900
                ...
                <div class="lg:col-span-2">
                    <div class="grid grid-cols-1 gap-5 md:grid-cols-2">
                        ...
                        <div>
                            ...
                            <input type="text" readonly disabled value="{{ old('position', $employee->position) }}"
                                class="{{ $inputClass }}" />
                            @error('position')
                                <p class="mt-2 text-sm text-rose-600">{{ $message }}</p>
                            @enderror
                        ...
                        <div>
                            ...
                            <select readonly disabled class="{{ $inputClass }}">
                        ...
                        <div>
                            ...
                            <select x-ref="country" name="country" class="{{ $inputClass }}">
                        ...
                        <div>
                            ...
                            <select x-ref="province" name="province" class="{{ $inputClass }}">
                        ...
                        <div>
                            ...
                            <select x-ref="city" name="city" class="{{ $inputClass }}">
                        ...
                        <div>
                            ...
                            <input type="text" name="postal_code"
                                value="{{ old('postal_code', $employee->postal_code) }}" class="{{ $inputClass }}" />
                            @error('postal_code')
                                <p class="mt-2 text-sm text-rose-600">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="md:col-span-2">
                            ...
                            <textarea name="address" rows="4" class="{{ $inputClass }}">{{ old('address', $employee->address) }}</textarea>
                            @error('address')
                                <p class="mt-2 text-sm text-rose-600">{{ $message }}</p>
                            @enderror
                        </div>
