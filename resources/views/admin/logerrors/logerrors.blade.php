                ...
                <table class="w-full text-sm text-left text-gray-900">
                    <thead class="bg-[#5aba6f]/70 text-gray-900">
                        <tr class="[&>th]:border-b [&>th]:border-gray-500">
                            <th scope="col" class="px-6 py-4 font-extrabold text-left">Message</th>
                            <th scope="col" class="px-6 py-4 font-extrabold text-left">file</th>
                            <th scope="col" class="px-6 py-4 font-extrabold text-left">Line</th>
                            <th scope="col" class="px-6 py-4 font-extrabold text-left">User</th>
                    ...
                    <tbody class="bg-gray-200 divide-y divide-gray-500">
                        @forelse ($logerrors as $error)
                            <tr class="[&>td]:border-b [&>td]:border-gray-400 hover:bg-gray-100">
                                ...
                                <td class="px-6 py-4">{{ $error->file }}</td>
                                <td class="px-6 py-4">{{ $error->line }}</td>
                                <td class="px-6 py-4">{{ $error->user }}</td>
                                <td class="px-6 py-4">{{ $error->created_at }}</td>
                            </tr>
                        @empty
                            <tr>
