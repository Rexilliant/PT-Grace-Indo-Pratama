    ...
    <form action="#" method="POST" enctype="multipart/form-data" class="space-y-5">
        ...
        <section class="bg-white p-5 shadow border border-gray-300 rounded-lg">
            ...
            <div class="flex flex-col sm:flex-row sm:items-center gap-6">
                <div class="shrink-0">
                    <div class="w-30 h-30 rounded-full bg-black flex items-center justify-center overflow-hidden">
        ...
        <section class="bg-white p-5 shadow border border-gray-300 rounded-lg">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div>
                    <label class="block text-xs font-bold text-gray-700 mb-2">Nama Depan</label>
                ...
                <div>
                    <label class="block text-xs font-bold text-gray-700 mb-2">Nama Belakang</label>
                ...
                <div>
                    ...
                    <select name="country"
                        ...
                        @foreach ($countries as $c)
                            <option value="{{ $c }}" @selected(old('country', 'Indonesia') === $c)>
                                {{ $c }}
                            </option>
                        @endforeach
                    </select>
