...
@section('content')
    ...
    <section class="mb-5">
        <div class="text-xl font-semibold text-gray-700">
            ...
            <span class="text-blue-600">Edit Role</span>
        </div>
    </section>

    <section class="p-5 rounded-md shadow-sm border border-gray-400">
        <form action="{{ route('update.role', $role->id) }}" method="POST" class="space-y-6">
            @csrf
            @method('PUT')
            ...
            {{-- Permissions --}}
            <div x-data="{
                selected: @js(old('permissions', $role->permissions->pluck('name')->toArray())),
                ...
                <div
                    ...
                    <div>
                        ...
                        <p class="text-xs text-slate-500">Update permission untuk role ini.</p>
                    </div>
            ...
            <div class="flex flex-col gap-3 sm:flex-row">
                <button type="submit"
                    class="inline-flex items-center justify-center rounded-2xl bg-blue-600 px-5 py-3 text-sm font-semibold text-white shadow-sm shadow-blue-600/20 hover:bg-blue-500 focus:outline-none focus:ring-4 focus:ring-blue-600/30">
                    Update Role
                </button>
            </div>
        </form>
